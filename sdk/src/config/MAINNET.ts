...
const MAINNET: { [chain in MainnetChainName]: ChainConfig } = {
  ethereum: {
    ...
    contracts: {
      ...
      portico: '0xd8E1465908103eD5fd28e381920575fb09beb264',
  ...
  polygon: {
    ...
    contracts: {
      ...
      portico: '0xf6C5FD2C8Ecba25420859f61Be0331e68316Ba01',
      uniswapQuoterV2: '0x61fFE014bA17989E743c5F6cB21bF9697530B21e',
    },
  ...
  arbitrum: {
    ...
    contracts: {
      ...
      portico: '0xf8497FE5B0C5373778BFa0a001d476A21e01f09b',
      uniswapQuoterV2: '0x61fFE014bA17989E743c5F6cB21bF9697530B21e',
    },
    finalityThreshold: 0,
    nativeTokenDecimals: 18,
  ...
  optimism: {
    ...
    contracts: {
      ...
      tbtcGateway: '0x1293a54e160D1cd7075487898d65266081A15458',
      portico: '0xcF205Fa51D33280D9B70321Ae6a3686FB2c178b2',
      uniswapQuoterV2: '0x61fFE014bA17989E743c5F6cB21bF9697530B21e',
    },
    finalityThreshold: 0,
    nativeTokenDecimals: 18,
  ...
  base: {
    ...
    contracts: {
      ...
      tbtcGateway: '0x09959798B95d00a3183d20FaC298E4594E599eab',
      portico: '0x9816d7C448f79CdD4aF18c4Ae1726A14299E8C75',
